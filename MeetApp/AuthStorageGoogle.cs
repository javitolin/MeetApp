...
namespace MeetApp
{
    public class AuthStorageGoogle : IDataStore
    {
        ...
        public AuthStorageGoogle(String _server, string _login, string _password, string _databasename, string _tableName)
        {
            ...
            if (_ConnectionExists)
            {
                ...
                try
                {
                    ...
                    SqlCommand myCommand = new SqlCommand("select 1 from "+ tableName +" where 1 = 0",
                                             myConnection);
                ...
                catch
                {
                    ...
                    SqlCommand myCommand = new SqlCommand("CREATE TABLE [dbo].["+tableName+"]( " +
        ...
        public Task StoreAsync<T>(string key, T value)
        {
            ...
            using (SqlCommand command = new SqlCommand("select Userid from "+tableName+" where UserName = @username", myConnection))
            {
                ...
                if (hold == null)
                {
                    try
                    {
                        ...
                        string insertString = "INSERT INTO [dbo].["+tableName+"]  ([username],[RefreshToken],[Userid]) " +
                                              " VALUES (@key,@value,'1' )";
                ...
                else
                {
                    try
                    {
                        ...
                        string insertString = "update [dbo].["+tableName+"] " +
        ...
        public Task DeleteAsync<T>(string key)
        {
            ...
            string deleteString = "delete [dbo].[" + tableName + "] from " +                                 
                                  " where username = @key";
        ...
        public Task<T> GetAsync<T>(string key)
        {
            ...
            // Try and find the Row in the DB.
            using (SqlCommand command = new SqlCommand("select RefreshToken from " + tableName + " where UserName = @username;", myConnection))
            {
                command.Parameters.AddWithValue("@username", key);
        ...
        public Task ClearAsync()
        {
            ...
            string truncateString = "truncate table [dbo].[" + tableName + "] ";
